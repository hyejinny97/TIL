...
<img src='./image/로지스틱_손실_함수.png' alt='로지스틱 손실 함수' width='600px' />
...
- 훈련 세트 점수는 에포크가 진행될수록 꾸준히 증가하지만, 테스트 세트 점수는 어느 순간 감소하기 시작함
  ...
  <img src='./image/에포크_정확도_그래프.png' alt='에포크 정확도 그래프' width='400px' />
...
<img src='./image/실제_에포크_정확도_그래프.png' alt='실제 에포크 정확도 그래프' width='400px' />
