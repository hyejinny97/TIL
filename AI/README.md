...
- [합성곱 신경망의 시각화](./cnn_visualization.md)
  ...
  - cf) 핵심 패키지와 함수
    - Keras
- [➕ 파이토치로 합성곱 신경망 시각화하기](./cnn_visualization_by_pt.md)

### 9. 순환 신경망

- [순차 데이터와 순환 신경망](./rnn.md)
  - 순차 데이터
  - 순환 신경망
  - 셀의 가중치와 입출력
- [순환 신경망으로 IMDB 리뷰 분류하기](./classify_imdb_by_rnn.md)
  - IMDB 리뷰 데이터셋
  - 순환 신경망 만들기
  - 순환 신경망 훈련하기
  - 단어 임베딩 사용하기
  - cf) 핵심 패키지와 함수
    - Keras
- [➕ 파이토치로 순환 신경망 만들기](./rnn_by_pytorch.md)
- [LSTM과 GRU 셀](./lstm.md)
  - LSTM 구조
  - LSTM 신경망 훈련하기
  - 순환층에 드롭아웃 적용하기
  ...
  - cf) 핵심 패키지와 함수
    - Keras
- [➕ 파이토치로 LSTM 모델 훈련하기](./lstm_by_pt.md)

### 10. 트랜스포머

- [어텐션 메커니즘과 트랜스포머](./transformer.md)
  ...
  - 토큰 임베딩과 위치 인코딩
  - 디코더 블록
- [트랜스포머로 상품 설명 요약하기](./transformer_summary.md)
  - 트랜스포머 가계도
  - 전이 학습
  - BART 모델 소개
  - BART 인코더와 디코더
